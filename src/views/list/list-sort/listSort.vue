    ...
    <div class="sort">
        <div class="bd">
            <form name="listform">
               ...
               <!-- <a title="销量" class="curr" rel="nofollow" @click="sortType('-sold_num')"><span :class="{search_DESC: cur==='-sold_num'}">点击量排序</span></a>-->
                <a title="销量" class="curr" rel="nofollow" @click="sortType('-click_num')"><span :class="{search_DESC: cur==='-click_num'}">点击量排序</span></a>
                <a title="价格" class="curr" rel="nofollow" @click="sortType('-shop_price')"><span :class="{search_DESC: cur==='-shop_price'}">年龄排序</span></a>
        ...
        <div class="search_num">共<b>{{proNum}}</b>个相关消息 <span id="search_btn" class="search_btn"></span> </div>
    </div>
