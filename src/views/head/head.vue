  ...
  <div id="header" class="new_header">
    <div class="hd_bar">
        <div class="bd_bar_bd cle">
            ...
            <ul id="userinfo-bar">
                <li class="more-menu" @mouseover="isShowVip=true" @mouseout="isShowVip=false"> <a>登录</a><i class="iconfont arrow"> </i>
                    <div class="more-bd" :class="{show:isShowVip}">
                        <div class="list">
                      <!--  <router-link :to="'/app/home/member/order'">我的订单</router-link>-->
                           <router-link :to="'/app/home/member/order'">我的信息</router-link>
                        <router-link :to="'/app/home/member/collection'">我的收藏</router-link>
                      <!--    <router-link :to="'/app/home/member/collection'">我的收藏</router-link>-->
                        <router-link :to="'/app/home/member/receive'">修改密码</router-link>
    ...
    <div class="hd_main cle">
        ...
        <router-link to="/app/home/index" class="lizi_logo">
          <!--  <img src="../../static/images/head/logo.gif" alt="慕学生鲜商城">-->
           ...
           <img src="../../static/images/head/logo.png" alt="慕学生鲜商城" width="320" height="90">
        </router-link>
