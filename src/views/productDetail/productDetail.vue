                            ...
                            <ul>
                                ...
                                <li>
                                   <!--  <span class="lbl">市场价</span> <em class="cancel">￥{{proDetail.market_price}}元</em></li> -->
                                    <span class="lbl">身份证号</span> {{proDetail.market_price}}</li>
                                <li>
                                   ...
                                   <!-- <span class="icon_promo">联系方式</span>-->
                                  <span class="lbl">年龄</span><span class="unit"> <strong class="nala_price red" id="ECS_SHOPPRICE">{{proDetail.shop_price}}</strong> </span>  <span class="timedown" id="timedown"></span>
                               <p>&nbsp;</p>
                              <li v-if="proDetail.ship_free"><span class="icon_promo">参与评审，内容为</span> </li>
                              <!--<p class="desc"> <span class="icon_promo">评审内容：</span> </p>-->
                                 <p class="desc"> <span class="gray">{{proDetail.goods_sn}}</span> </p>
                                </li>
                                <li>
