<template>
    <div>
        ...
        <div class="newopro-l fl">
          <a href=""><img src="../../static/images/new/1_P_1449024889889.jpg" width="224" height="478"></a>
        </div>
           <div class="newopro-l fl">
          <a href=""><img src="../../static/images/new/2_P_1448945810202.jpg" width="224" height="478"></a>
        </div>
           <div class="newopro-l fl">
          <a href=""><img src="../../static/images/new/5_P_1448945270390.jpg" width="224" height="478"></a>
        </div>
           <div class="newopro-l fl">
          <a href=""><img src="../../static/images/new/7_P_1448945104734.jpg" width="224" height="478"></a>
        </div>

        <div class="newopro-r fr">
            <h2 class="index-tt">
                <!-- <em class="ft18 c000">新增消息</em> -->
                <router-link to="/app/home/list/more" target = _blank><a  class="fr c666">更多详情&gt;&gt;</a></router-link>
            </h2>
